...
- [ ] **Kopi Nusantara** (`KopiDemo.tsx`) — BERIKUTNYA. Brand e-commerce kopi specialty/UMKM, palet sage-green #4a5d3a + caramel #8a5a2b di atas cream #f5efe6. Gambar SUDAH diverifikasi & siap (di `/c/Users/user/AppData/Local/Temp/kopiimg/`): 5 lama OK — toasting cups `1495474472287-4d71bcdd2085`, beans `1447933601403-0c6688de566e`, espresso glass `1559496417-e7f25cb247f3`, pour-over `1442512595331-e89e73853f31`, cappuccino+plants `1509042239860-f550ce710b93`; + 2 baru terverifikasi — cherries/petani `1746623691157-c4c7a3bad0c4` (✅ valid), coffee-bag `1672042382060-8a08025310ef` (⚠️ ada label "Vulcan/Qatar" — boleh dipakai kecil atau skip). Rencana layout e-commerce distinct: announcement bar gratis ongkir, hero split product-forward, trust strip, **shop product grid** (Gayo/Toraja/Kintamani/Flores), **"dari kebun ke cangkir"** 3-step (cherries→beans→pour-over), brand story, featured product spotlight (dark espresso), testimoni, **newsletter/subscription CTA**, footer. (config lama di `demos.ts["kopi-nusantara"]` utk copy/harga.)
- [ ] **PrimaLand** (properti) & **EximTrade** (ekspor-impor) — masih pakai `DemoPage` template; rebuild bespoke berikutnya.
